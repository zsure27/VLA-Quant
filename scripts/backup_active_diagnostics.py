...
def main():
    ...
    with tarfile.open(backup / "code-overlay.tar.gz", "w:gz") as tar:
        for name in ("language-stage-rescue", "closed-loop-stage-rescue", "language-family-rescue", "closed-loop-fixed-coordinates", "low-rank-recovery", "fp32-smoothing-pairs"):
