...
payload={"schema_version":"1.0","question":"Does exact-12L rank8 Recovery LoRA avoid catastrophic regression or show a large positive signal on this paired development slice?","status":"PREREGISTERED_BEFORE_EXECUTION","suite":"libero_spatial","initial_state_offset":offset,"trials_per_task":count,"task_count":10,"episodes_per_config":count*10,"seed":0,"env_seed":0,"seed_protocol":"paired","configs":{"C0":{"w4_layers":"8-15,20-23","adapter":False},"C1":{"w4_layers":"8-15,20-23","adapter":"rank8 Recovery LoRA"},"C2":{"w4_layers":"8-15,18-23","adapter":False}},"case_directories":{"C0":"C0-12L","C1":"C1-12L-lora","C2":"C2-14L"},"adapter_state":{"path":str(state),"sha256":hashlib.sha256(state.read_bytes()).hexdigest(),"bytes":state.stat().st_size},"classification":"closed-loop stability pilot on a historical/development slice; not a W4 recovery-fraction test when C2-C0 headroom is zero; not final blind evaluation"}
