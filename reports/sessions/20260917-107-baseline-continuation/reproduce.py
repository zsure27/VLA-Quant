...
HERE=Path(__file__).resolve().parent;REPO=HERE.parents[2];RAW=REPO/"results/107-baseline-continuation-20260917";REFERENCE=REPO/"results/107-baseline-validation-20260917"
