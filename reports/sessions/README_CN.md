...
最新实测：[2026-09-24 269 语言 W4 12 层裁剪配对外推](20260924-269-awq-stage-generalization/README_CN.md)，在初态 10–24 完成 16 层与 12 层各 150 回合配对比较。

层数筛选：[2026-09-23 014 完整 W2 的语言 W4 层数裁剪](20260923-014-awq-stage-pruning/README_CN.md)，完成 22 个分片、580 回合，比较 8/10/12 层稀疏保护组合。
