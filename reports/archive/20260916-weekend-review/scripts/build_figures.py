...
Run: python reports/archive/20260916-weekend-review/scripts/build_figures.py
...
gate = read_json("results/experiments/p0-foundation-baselines/20260916-awq-baseline-gate/analysis/summary.json")
screen = read_json("results/experiments/p0-foundation-baselines/20260915-awq-visual-diagnostics/summary.json")
clip = read_json("results/experiments/p0-foundation-baselines/20260916-awq-w2-language-clip10/paired_w2_clip_comparison.json")
records = []
...
paired = read_csv("results/experiments/p0-foundation-baselines/20260916-awq-baseline-gate/analysis/paired_episodes.csv")
...
e2e = read_json("results/experiments/p0-foundation-baselines/20260916-awq-block-audit/e2e-interventions-old-summary.json")
rows = []
samples = []
...
archival = read_json("reports/archive/20260916-weekend-review/data/archival_offline.json")
...
historical = read_csv("results/shared/historical/official_quant_validation.csv")
...
block = read_json("results/experiments/p0-foundation-baselines/20260916-awq-block-audit/block-error-summary.json")
block_rows = []
...
manifest = {
    ...
    "source_hash_format": "Text inputs use UTF-8 bytes with CRLF normalized to LF; normalize text sources before verification, since some legacy Git blobs retain CRLF. Generated files use exact bytes; CSV and SVG are written with LF.",
