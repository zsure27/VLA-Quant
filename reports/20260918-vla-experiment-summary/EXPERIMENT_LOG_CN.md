...
> **2026-09-25 增量结果与执行覆盖：** 完整 W2/W4 混合底座在同一 Spatial500 上得到 16L 434/500、14L 431/500、12L 412/500；完整证据见[2026-09-24 至 25 会话报告](../sessions/20260924-233836_to_20260925-032607-107-awq-stage-complete/README_CN.md)。静态 block 搜索现已冻结，12L 固定为 blocks18–19 shared PEFT 主底座；后续因果顺序见[主线执行协议](../../docs/PEFT_CONTEXTUAL_ROUTING_EXECUTION_20260925_CN.md)。本日志中较早的“下一步”仅保留历史语境。
...
证据：[正式500报告](../sessions/20260917-107-baseline-continuation/README_CN.md)、[原始分片](../../results/107-baseline-continuation-20260917/)、[较早220回合分片](../../results/107-baseline-validation-20260917/)、[早期基线gate](../../results/awq-baseline-gate-20260916/)。
...
证据：[历史闭环表](../2026-09-16-weekend-review-archive/data/closed_loop.csv)、[早期可视化诊断](../../results/awq-visual-diagnostics-20260915/)、[来源与边界](../2026-09-16-weekend-review-archive/README_CN.md)。
...
证据：[语言CSV及逐帧数据](../2026-09-16-weekend-review-archive/data/)、[来源摘要](../2026-09-16-weekend-review-archive/data/archival_offline.json)。
...
证据：[视觉历史CSV](../2026-09-16-weekend-review-archive/data/vision_offline.csv)、[组合逐帧记录](../2026-09-16-weekend-review-archive/data/vision_combination_validation.csv)。
...
证据：[原始metrics和controls](../../results/awq-block-audit-20260916/)、[局部误差CSV](../2026-09-16-weekend-review-archive/data/selected_block_error.csv)。
...
证据：[阶段原始结果](../../results/107-diagnostics-20260916/)、[扩大50原始结果](../../results/107-followup-20260916/)、[阶段逐帧/动作维度CSV](../sessions/20260916-107-diagnostics/data/)、[50回合CSV](../sessions/20260916-107-followup/data/closed_loop_50.csv)。
...
证据：[模块族CSV](../sessions/20260916-107-diagnostics/data/family_summary.csv)、[固定坐标CSV](../sessions/20260916-107-followup/data/awq_summary.csv)、[对应原始metrics](../../results/107-followup-20260916/)。
...
证据：[原始测量](../../results/107-followup-20260916/)、[低秩汇总与逐帧](../sessions/20260916-107-followup/data/low_rank_summary.csv)。
...
证据：[输入加权CSV](../sessions/20260916-107-followup/data/input_diag_summary.csv)、[原始metrics与校准manifest](../../results/107-followup-20260916/)。
...
证据：[本轮报告](../sessions/20260917-107-response-svd/README_CN.md)、[源数据](../sessions/20260917-107-response-svd/data/)、[原始结果](../../results/107-response-svd-20260917/)。
...
证据：[本轮报告](../sessions/20260917-107-baseline-continuation/ANALYSIS_CN.md)、[原始语言分片](../../results/107-baseline-continuation-20260917/)、[最新合并scope数据](../sessions/20260918-107-awq-continuation/data/scope_paired_episodes.csv)。
...
证据：[profile逐字段核验](../sessions/20260918-107-awq-continuation/data/profile-provenance/)、[开发四格](../sessions/20260918-107-awq-continuation/data/language_clip_factorial.json)、[扩展分批数据](../sessions/20260918-107-awq-continuation/data/language_attention_splits.json)、[原始分片](../../results/107-awq-continuation-20260918/)。
...
证据：[500分析](../sessions/20260918-107-awq-continuation/ANALYSIS_CN.md)、[逐任务/逐回合CSV](../sessions/20260918-107-awq-continuation/data/)、[旧250原始日志](../../results/107-baseline-continuation-20260917/)、[新250原始日志](../../results/107-awq-continuation-20260918/)。
...
证据：[最新scope汇总](../sessions/20260918-107-awq-continuation/data/scope_summary.json)、[full-w2两个原始目录](../../results/107-awq-continuation-20260918/)。
...
证据：[历史SQ CSV](../2026-09-16-weekend-review-archive/data/historical_sq.csv)、[当前控制CSV](../sessions/20260916-107-diagnostics/data/sq_control_summary.csv)、[原始summary/metrics](../../results/107-diagnostics-20260916/)。
...
证据：[分支与逐组CSV](../sessions/20260916-107-followup/data/)、[局部原始metrics](../../results/107-followup-20260916/)。
...
证据：[FP32汇总/逐帧](../sessions/20260916-107-followup/data/sq_fp32_pairs_summary.csv)、[原始FP32结果](../../results/107-followup-20260916/)。
...
证据：[正互补JSON](../sessions/20260918-107-awq-continuation/data/language_all_attention_complementarity.json)、[负互补JSON](../sessions/20260918-107-awq-continuation/data/language_g128_g64_complementarity.json)。
...
证据：[OFT审计汇总](../sessions/20260917-107-baseline-continuation/data/oft_adapter_scope_summary.json)。
...
[最新收尾回执](../sessions/20260918-107-awq-continuation/closure.json)记录原生请求execute=true、准备无错误；平台OFF与停止计费未独立核验。汇总数据及上述每项来源SHA详见[结果数据](EVIDENCE_INDEX.json)。
