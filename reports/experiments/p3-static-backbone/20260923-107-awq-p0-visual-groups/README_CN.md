...
python diagnostics/analyze_awq_p0_groups.py \
  results/experiments/p3-static-backbone/20260923-107-awq-p0-visual-groups \
  reports/experiments/p3-static-backbone/20260923-107-awq-p0-visual-groups/data/paired-results.json \
  --both-g64-run results/experiments/p0-foundation-baselines/20260918-107-awq-continuation/awq-scope-shard-full-w2-g64-attention-no-clip-05-09-20260918-032153-93284
```
