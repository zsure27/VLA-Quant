...
日期：2026-09-17。本轮确认107开机后，已完成官方初态5–26的BF16/AWQ W4各220回合（215/220、214/220）；五小时剩余9%收尾，13:40:57执行原生关机请求、SSH远端关闭，平台OFF尚未独立核验。尚欠各280回合，等待下次手动开机并确认实例。最新优先级：AWQ基线实验优先，SQ和微调其次；手动开机后通过SSH开展实验，仍不自行登录或开机。
